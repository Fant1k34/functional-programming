...
defineCoefficientOnPlanet :: Planet -> Either String Float
defineCoefficientOnPlanet planet = case planet of
  Mercury -> Right 0.2408467
  Venus -> Right 0.61519726
  Earth -> Right 1.0
  Mars -> Right 1.8808158
  Jupiter -> Right 11.862615
  Saturn -> Right 29.447498
  Uranus -> Right 84.016846
  Neptune -> Right 164.79132
  Pluto -> Left "Pluto is not a planet anymore"

computeAge :: Float -> Float -> Float
computeAge koef timeInSeconds = let yearsOnEarth = timeInSeconds / 31557600
                                in  yearsOnEarth / koef

ageOn :: Planet -> Float -> Either String Float
ageOn planet ageInSeconds = case (defineCoefficientOnPlanet planet) of
  Left errorComment -> Left errorComment
  Right koef -> Right (computeAge koef ageInSeconds)
